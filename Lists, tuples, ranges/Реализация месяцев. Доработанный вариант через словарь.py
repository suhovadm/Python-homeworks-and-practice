# * Этот же скрипт есть в папке Dictionaries.
...
# Создаём обратный словарь, созданный с помощью генератора словарей.
# Он сопоставляет название месяца (строка) с его номером (числом).
# Например, 'январь' - 1.
