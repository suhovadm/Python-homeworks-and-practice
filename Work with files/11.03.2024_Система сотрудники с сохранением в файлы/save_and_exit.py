...
def save_and_exit():
    try:
        ...
        # Открываем файл IN.txt на чтение, задаём ему кодировку utf8, задаём ему алиас f5.
        # Следом за ним открываем файл OUT.txt на запись, задаём ему кодировку utf8, задаём ему алиас f6.
        # with обеспечит нам автоматическое закрытие файлов после выхода из блока.
        with open('IN.txt', 'r', encoding='utf8') as f5, open('OUT.txt', 'w', encoding='utf8') as f6:
