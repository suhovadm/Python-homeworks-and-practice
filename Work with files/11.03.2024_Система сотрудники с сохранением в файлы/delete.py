...
def perform_delete():
    ...
    # Открываем файл IN.txt на чтение с кодировкой utf8, задаём ему алиас f для дальнейших манипуляций.
    ...
    # Снова открываем файл IN.txt, только теперь уже на запись с кодировкой utf8, задаём ему
