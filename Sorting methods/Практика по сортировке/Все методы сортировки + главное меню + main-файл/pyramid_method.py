...
# Имортируем функцию randint из библиотеки random, которая позволяет генерировать
# случайное число в заданном диапазоне. Оно будет использоваться для создания случайных
# элементов списка.
...
# Создаём список из 10 случайных чисел в диапазоне от -10 до 10 включительно.
